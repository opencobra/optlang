...
class VariableTestCase(unittest.TestCase):
    ...
    def test_variable_without_problem_raises_index_error(self):
        print self.var.index
        self.assertRaises(IndexError, getattr, self.var, 'index')
