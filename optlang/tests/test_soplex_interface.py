# Copyright (c) 2017 Novo Nordisk Foundation Center for Biosustainability, DTU.
...
from optlang import soplex_interface
...
class ConfigurationTestCase(abstract_test_cases.AbstractConfigurationTestCase):
    ...
    def test_lp_method(self):
        for option in soplex_interface._LP_METHODS:
